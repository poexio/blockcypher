 ...
 */
const Blockcy = function (coin, chain, token, url = URL_ROOT) {
  this.coin = coin
  this.chain = chain
  this.token = token
 ...
 * @method            get
 */
Blockcy.prototype._get = function (path, params) {
 ...
 * @method            post
 */
Blockcy.prototype._post = function (path, params, data) {
  const urlr = this.url + this.coin + '/' + this.chain + path
  params = Object.assign({}, params, {token: this.token})
  return request.post({
    url: urlr,
 ...
 * @method            get
 */
Blockcy.prototype._del = function (path, params) {
  const urlr = this.url + this.coin + '/' + this.chain + path
  params = Object.assign({}, params, {token: this.token})
  return request.del({
    url: urlr,
